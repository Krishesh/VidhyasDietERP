...
class Registration(models.Model):
    ...
    customer = models.ForeignKey(Customer, on_delete=models.DO_NOTHING, blank=True, default='', related_name="customer",
                                 db_constraint=False)
    employee = models.ForeignKey(Employee, on_delete=models.DO_NOTHING, blank=True, default='', related_name="employee",
                                 db_constraint=False)
    account_by = models.ForeignKey(Employee, on_delete=models.DO_NOTHING, blank=True, default='',
                                   related_name="account_by", db_constraint=False)
    inquiry = models.ForeignKey(Inquiry, on_delete=models.DO_NOTHING, blank=True, default='', related_name="inquiry",
                                db_constraint=False)
